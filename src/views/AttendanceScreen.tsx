                  ...
                  filteredReportData.map(r => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-4 gap-2 text-center select-none">
                        ...
                        <div className="bg-rose-50 dark:bg-rose-950/25 p-2 border border-rose-500/10 rounded-xl">
                ...
                {workers.length === 0 ? (
                  ...
                  workers.map(w => {
                    ...
                    return (
                      <div 
                        key={w.id} 
                        className="bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-855/60 flex items-center justify-between transition-colors duration-150"
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-gradient-to-br from-indigo-50 to-indigo-100/50 dark:from-slate-800 dark:to-slate-855 rounded-2xl flex items-center justify-center font-black text-indigo-600 dark:text-indigo-400 shrink-0 text-sm">
                            {letter}
                          </div>
                          <div>
                            <h3 className="font-extrabold text-sm text-slate-900 dark:text-slate-100 leading-snug">{w.name}</h3>
              ...
              <form onSubmit={handleSaveWorker} className="p-5 space-y-4">
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-[9px] text-slate-400 italic font-semibold">({t.optional})</span>
                  </div>
                  <input 
                    type="tel" 
