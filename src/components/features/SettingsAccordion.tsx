      ...
      <AnimatePresence initial={false}>
        {isOpen && !isLocked && !disabled && (
          ...
          >
            ...
            <div className="p-3.5 sm:p-4 pl-4 sm:pl-6 pr-3.5 sm:pr-6 ml-2 sm:ml-4 mr-2 sm:mr-4 border-l-2 border-indigo-400/70 dark:border-emerald-500/50 space-y-4 min-w-0 overflow-hidden">
              {children}
            </div>
          </motion.div>
        )}
