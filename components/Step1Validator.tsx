...
import { getDb } from '../src/services/billingService';
              ...
              <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm">
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs text-gray-600 dark:text-slate-300">
                    <thead className="bg-gray-50 dark:bg-slate-950/60 border-b border-gray-200 dark:border-slate-850 font-bold text-gray-500 dark:text-slate-400">
                      <tr>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2.5">
                  {qaResult.results.map((test) => (
                    <details 
                      key={test.id} 
                      className="group border border-slate-850 bg-black/20 hover:bg-black/40 rounded-xl transition-all"
                      open
                    >
                      ...
                      <div className="px-4 pb-4 pt-1 border-t border-slate-900/85 text-xs text-slate-350 space-y-3">
                        <p className="leading-relaxed opacity-95 text-[11px] font-sans">{test.message}</p>
                        
                        {test.details && (
                          <div className="space-y-1">
                            <span className="text-[9px] uppercase tracking-wider font-bold text-slate-555 block font-sans">Calculated Parity Metrics & Payloads:</span>
                            <div className="bg-black/60 border border-slate-850 p-2.5 rounded-lg overflow-x-auto">
